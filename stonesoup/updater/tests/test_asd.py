...
from ...types.prediction import ASDGaussianMeasurementPrediction, ASDGaussianStatePrediction
...
def test_asdkalman():
    ...
    eval_measurement_prediction = ASDGaussianMeasurementPrediction(
        ...
        multi_covar=measurement_model.matrix() @ prediction.covar @ measurement_model.matrix().T
        + measurement_model.covar(),
        cross_covar=cross_cov,
