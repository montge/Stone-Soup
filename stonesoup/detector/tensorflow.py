...
class TensorFlowBoxObjectDetector(_VideoAsyncBoxDetector):
    ...
    def _get_detections_from_frame(self, frame):
        ...
        for box, class_, score in zip(boxes, classes, scores, strict=False):
            metadata = {"raw_box": box, "class": self.category_index[class_], "score": score}
            ...
            detection = Detection(
                state_vector=state_vector, timestamp=frame.timestamp, metadata=metadata
            )
