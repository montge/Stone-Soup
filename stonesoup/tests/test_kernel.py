...
samples = multivariate_normal.rvs(
    [0, 0, 0, 0], np.diag([0.01, 0.005, 0.1, 0.5]) ** 2, size=number_particles, random_state=rng
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            StateVectors(
                [
                    [0.12615663, 0.11295446, 0.12592767, 0.11836642, 0.09369041],
        ...
        (
            ...
            StateVectors(
                [
                    [0.12402707, 0.12167346, 0.12302255, 0.12608029, 0.12361090],
        ...
        (
            ...
            StateVectors(
                [
                    [1.12546138, 0.89290663, 1.10262155, 0.94640177, 0.75809725],
        ...
        (
            ...
            StateVectors(
                [
                    [1.03096874, 0.98911714, 1.01165201, 1.10961207, 1.02462261],
        ...
        (
            ...
            StateVectors(
                [
                    [1.26666331, 0.79728225, 1.21577428, 0.89567631, 0.57471144],
        ...
        (
            ...
            StateVectors(
                [
                    [1.06289653, 0.97835271, 1.02343979, 1.23123896, 1.04985149],
    ...
    ids=[
        ...
        "quartic",
        "quartic_w_prop",
        "gaussian_prior_as_state_vector",
        "gaussian_proposal_as_state_vector",
        "quadratic_prior_as_state_vector",
        "quadratic_proposal_as_state_vector",
        "quartic_prior_as_state_vector",
        "quartic_proposal_as_state_vector",
    ],
)
...
@pytest.mark.parametrize("power", [1, 2, 3, 4, 5], ids=["1", "2", "3", "4", "5"])
...
@pytest.mark.parametrize(
    "kernel_class",
    [LinearKernel, QuadraticKernel, QuarticKernel, GaussianKernel],
...
@pytest.mark.parametrize(
    ...
    [
        (LinearKernel, {}, {}),
        (QuadraticKernel, {"c": 1, "ialpha": 10}, {"c": 2, "ialpha": 10}),
        (QuarticKernel, {"c": 1, "ialpha": 10}, {"c": 2, "ialpha": 10}),
        (GaussianKernel, {"variance": 10}, {"variance": 20}),
    ],
    ids=["Linear", "Quadratic", "Quartic", "Gaussian"],
)
...
@pytest.mark.parametrize(
    ...
    [
        (TrackKernel, LinearKernel, {}, {}),
        (TrackKernel, QuadraticKernel, {"c": 1, "ialpha": 10}, {"c": 2, "ialpha": 10}),
        (MeasurementKernel, QuarticKernel, {"c": 1, "ialpha": 10}, {"c": 2, "ialpha": 10}),
        (MeasurementKernel, GaussianKernel, {"variance": 10}, {"variance": 20}),
    ],
    ids=["Linear", "Quadratic", "Quartic", "Gaussian"],
)
