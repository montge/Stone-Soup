...
class ClearMotAssociator(TwoTrackToTrackAssociator):
    ...
    def associate_tracks(
        self, tracks_set: set[Track], truth_set: set[GroundTruthPath]
    ) -> AssociationSet:
        """Associate Tracks
        ...
        (
            timestamps,
            truth_states_by_time_id,
            track_states_by_time_id,
            truth_tracks_by_id,
            estim_tracks_by_id,
        ...
        for current_time in timestamps:
            ...
            ) = self._forward_matches_from_previous_timestep(
                truth_states_by_id,
                track_states_by_id,
                matches_previous,
            ...
            matches_from_unassigned = self._match_unassigned_tracks(
                truth_states_by_id,
                track_states_by_id,
                remaining_truth_ids_at_current_time,
                remaining_track_ids_at_current_time,
    ...
    def _prepare_timestamps_and_helpful_lookups(
        self, tracks_set: set[Track], truth_set: set[Track]
    ) -> tuple[
    ...
    def _create_associations_from_matches_over_time(
        self,
            ...
            for start_idx, end_idx in time_intervals:
                associations.add(
                    TimeRangeAssociation(
                        ...
                        TimeRange(
                            timestamps[timesteps_where_match_exists[start_idx]],
    ...
    def _forward_matches_from_previous_timestep(
        self,
